defmodule SportsPredictorsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SportsPredictorsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SportsPredictorsWeb.Gettext, "errors", msg, opts)
    end
  end
